...
export default function Home() {
  ...
  if (closed) return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', position: 'relative' }}>
      <BgLayers /><TopBar />
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', textAlign: 'center', position: 'relative', zIndex: 10 }}>
        <div style={{ backdropFilter: 'blur(22px) saturate(1.6)', WebkitBackdropFilter: 'blur(22px) saturate(1.6)', background: 'rgba(0,12,24,0.38)', border: '0.5px solid rgba(255,255,255,0.13)', borderRadius: 18, padding: 32, maxWidth: 320 }}>
      ...
      <div style={{ position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <div className="fade" style={{ padding: '0 20px' }}>
          <div style={{
            ...
            borderRadius: 18, padding: 20, textAlign: 'center', position: 'relative', overflow: 'hidden',
          }}>
            ...
            <h1 style={{ fontSize: 26, fontWeight: 900, lineHeight: 1.15, marginBottom: 8, letterSpacing: '-0.02em' }}>
              Predict the score.<br /><em style={{ fontStyle: 'italic', color: '#F18000' }}>Enter the pool.</em>
            </h1>
            <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.48)', fontWeight: 500, lineHeight: 1.75, marginTop: 8 }}>
        ...
        <div style={{ display: 'flex', gap: 8, margin: '14px 20px 0' }}>
          {[['1','Prize'],['Free','Entry'],['21:00','Closes']].map(([val, key], i) => (
            <div key={key} className={`fade-d${i+2}`} style={{
              flex: 1, backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)',
        ...
        {/* Pool strip */}
        <div className="fade-d4" style={{
          margin: '14px 20px 0', backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)',
          ...
          <div className="blink" style={{ width: 6, height: 6, background: '#84CEEF', borderRadius: '50%', flexShrink: 0, animation: 'blink 2s infinite' }} />
        ...
        <div className="fade-d5" style={{ padding: '20px 20px 8px' }}>
          <button onClick={() => router.push('/predict')} style={{
