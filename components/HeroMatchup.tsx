export default function HeroMatchup() {
  return (
    <div style={{ padding:'28px 20px 20px',textAlign:'center',position:'relative',zIndex:10 }}>
      <p style={{ fontSize:9,fontWeight:700,letterSpacing:'0.25em',textTransform:'uppercase',color:'#84CEEF',marginBottom:18,opacity:0.9 }}>FIFA World Cup 2026 · Group Stage</p>
      <div style={{ display:'flex',alignItems:'center',justifyContent:'center',marginBottom:16 }}>
        <div style={{ flex:1,textAlign:'center' }}>
          <span className="flag-left" style={{ fontSize:40,lineHeight:1,marginBottom:6,filter:'drop-shadow(0 4px 14px rgba(0,0,0,0.45))' }}>🇿🇦</span>
        ...
        <div style={{ flex:1,textAlign:'center' }}>
          <span className="flag-right" style={{ fontSize:40,lineHeight:1,marginBottom:6,filter:'drop-shadow(0 4px 14px rgba(0,0,0,0.45))' }}>🇲🇽</span>
