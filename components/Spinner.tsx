'use client'
interface SpinnerProps { value: number; onChange: (v: number) => void }
  ...
  return (
    <div style={{
      ...
      <button onClick={() => onChange(Math.max(0, value - 1))} style={{
        background: 'transparent', border: 'none', color: '#F18000',
        fontSize: 21, fontWeight: 700, width: 42, height: 54,
